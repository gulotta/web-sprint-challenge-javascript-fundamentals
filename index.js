...
// The 'internal' variable lives within the 'nestedFunction' function brackets so 'internal' can be accessed when 'nestedFunction' is logged. (function scope).
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
   const displayNames = [];
   array.forEach((a, b) => {
    displayNames.push(`name: ${array[b].animal_name}, scientific: ${array[b].scientific_name}`)
   })
...
console.log(animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(array){
    const newArray = array.map((a, b) => {
      return array[b].animal_name.toLowerCase();
    })
    return newArray;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const newArray = array.filter((a, b) => {
      return array[b].population < 5;
    })
    return newArray;
  }
  ...
  */
  ...
  function USApop(array){
    const newArray = array.reduce((accumulator, b) => {
      return b.population + accumulator
    }, 0)
    return newArray
  }
